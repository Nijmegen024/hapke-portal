...
mkdir -p "$PUB_CACHE/hosted/pub.dev/flutter_secure_storage-9.1.0/ios/Classes"
cat > "$PUB_CACHE/hosted/pub.dev/flutter_secure_storage-9.1.0/ios/Classes/FlutterSecureStoragePlugin.h" <<'EOF'
